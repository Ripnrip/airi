...
export class ExtensionHost {
  ...
  async startExtension(
    extension: Extension,
    options: { manifest: ExtensionManifestV1 },
  ) {
  ...
  async load(manifest: ExtensionManifestV1, options: PluginLoadOptions = {}): Promise<ExtensionHostSession> {
  ...
  async init(sessionId: string, options: PluginStartOptions = {}): Promise<ExtensionHostSession> {
  ...
  async start(manifest: ExtensionManifestV1, options: PluginStartOptions = {}) {
